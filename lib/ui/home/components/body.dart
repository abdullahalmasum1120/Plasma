...
import 'package:blood_donation/ui/find_donors/donors.dart';
import 'package:blood_donation/ui/home/logic/blocs/requests_bloc/requests_bloc.dart';
...
class _MyBodyState extends State<MyBody> {
  ...
  Widget build(BuildContext context) {
    return new BlocProvider<RequestsBloc>(
      ...
      child: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
          ...
          builder: (context, snapshot) {
            ...
            List<QueryDocumentSnapshot<Map<String, dynamic>>> requests =
                snapshot.data!.docs;
            return new BlocListener<RequestsBloc, RequestsState>(
              listener: (context, state) {
                if (state is FetchedDataState) print(state.requests);
              },
