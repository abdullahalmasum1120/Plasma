                ...
                child: Form(
                  ...
                  child: Column(
                    children: [
                      ...
                      TextFormField(
                        validator: (username) {
                          // if (FormValidatorRepository.isValidateUsername(username!)) {
                          //   return null;
                          // }
                      ...
                      TextFormField(
                        validator: (email) {
                          // if (FormValidatorRepository.isValidateEmail(email!)) {
                          //   return null;
                          // }
                      ...
                      TextFormField(
                        validator: (location) {
                          // if (FormValidatorRepository.isValidateLocation(location!)) {
                          //   return null;
                          // }
                          // return "Please Enter a valid Username";
                        },
